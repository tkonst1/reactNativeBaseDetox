...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      ...
      // build: 'xcodebuild -workspace ios/AwesomeProject.xcworkspace -scheme AwesomeProject -configuration Debug -sdk iphonesimulator -derivedDataPath ios/DerivedData'  
    },
    'ios.release': {
      type: 'ios.app',
  ...
  configurations: {
    'ios.lambdatest': {
      ...
      binaryPath: 'ios/build/Build/Products/Debug-iphonesimulator/AwesomeProject.app',
      build: '1',
      device: 'lambdaSimulator',
      app: 'ios.debug',
      session: {
        server: 'ws://<LAMBDATEST_USERNAME>:<LAMBDATEST_ACCESS_KEY>@hub.lambdatest.com/wd/hub',
        capabilities: {
          name: 'Your Test Name',
          platformName: 'iOS',
